...
/// </summary>
public class OVRCustomGrabbable : MonoBehaviour
{
    [SerializeField]
    ...
    protected OVRCustomGrabber m_grabbedBy = null;

    bool grabBegin = false;
	...
	/// </summary>
    public OVRCustomGrabber grabbedBy
    {
	...
	/// </summary>
	virtual public void GrabBegin(OVRCustomGrabber hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
