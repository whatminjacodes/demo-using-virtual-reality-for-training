...
public class OVRCustomGrabber : MonoBehaviour
{
	...
	protected OVRCustomGrabbable m_grabbedObj = null;
    protected Vector3 m_grabbedObjectPosOff;
    protected Quaternion m_grabbedObjectRotOff;
	protected Dictionary<OVRCustomGrabbable, int> m_grabCandidates = new Dictionary<OVRCustomGrabbable, int>();
	protected bool m_operatingWithoutOVRCameraRig = true;

    /// <summary>
    /// The currently grabbed object.
    /// </summary>
    public OVRCustomGrabbable grabbedObject
    {
        get { return m_grabbedObj; }
    }

	public void ForceRelease(OVRCustomGrabbable grabbable)
    {
        bool canRelease = (
            (m_grabbedObj != null) &&
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
		...
		OVRCustomGrabbable grabbable = otherCollider.GetComponent<OVRCustomGrabbable>() ?? otherCollider.GetComponentInParent<OVRCustomGrabbable>();
    ...
    protected virtual void GrabBegin()
    {
		...
		OVRCustomGrabbable closestGrabbable = null;
        Collider closestGrabbableCollider = null;

        // Iterate grab candidates and find the closest grabbable candidate
		foreach (OVRCustomGrabbable grabbable in m_grabCandidates.Keys)
        {
	...
	protected virtual void OffhandGrabbed(OVRCustomGrabbable grabbable)
    {
